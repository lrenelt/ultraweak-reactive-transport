...
#include "../darcy-velocity/darcy_mixed_solver.hh"
#include "../darcy-velocity/darcy_problem.hh"
...
int main(int argc, char** argv)
{
  try{
    ...
    CatalysatorProblem3<typename Grid::LeafGridView, RF> darcyProblem(pTree);
